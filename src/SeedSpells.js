...
export default class SeedSpells extends React.Component {
  ...
  seed(){
    ...
    firebase.database().ref('/statistics/spells_count').set(total)
  }
...
At the end of each of its turns, and each time it takes damage, the target can make another Wisdom saving throw. The target has advantage on the saving throw ifit\'s triggered by damage. On a success, the spell ends.`
  ...
  },
  {
    ...
    descriptions: {
      main: "You unleash a string of insults laced with subtle enchantments at a creature you can see within range. If the target can hear you (though it need not understand you), it must succeed on a Wisdom saving throw or take 1d4 psychic damage and have disadvantage on the next Attack roll it makes before the end of its next turn. ",
      level: "This spell's damage increases by 1d4 when you reach 5th level (2d4), 11th level (3d4), and 17th level (4d4)."
    }
  },
  {
    name: "Thaumaturgy",
