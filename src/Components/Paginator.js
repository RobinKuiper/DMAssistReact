...
export const PaginatorButtons = ({ page, totalPages, handlePageChange }) => (
  <Button.Group size='tiny'>
    ...
    <Dropdown button disabled={options(totalPages).length === 1} value={page+1} text={page+1 + '/' + totalPages} options={options(totalPages)} onChange={(e, { searchQuery, value }) => { handlePageChange(value-1) } } />
