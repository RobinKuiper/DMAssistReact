...
export const MonsterItem = ({ monster, encounters, encounter }) => (
    <Item key={monster.key}>
      ...
      { Auth.currentUser && encounter &&
        <Popup content='Add to encounter' trigger={<Button floated='right' icon='plus' content={'Add to encounter'} onClick={() => encounters.addMonster(monster) } />} />
      }
    </Item>
)